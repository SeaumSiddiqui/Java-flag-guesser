public class CountryNameDB {
    //in-memory DB
    public static final String[] countryNameDB = {
            ...
            "Barbados", "Belarus", "Belgium", "Belize", "Benin", "Bermuda", "Bhutan", "bl",
            ...
            "Croatia", "Cuba", "Curaçao", "Cyprus", "Czech Republic", "Côte d'Ivoire", "Denmark",
            "Djibouti", "Dominica", "Dominican Republic", "Ecuador", "Egypt", "El Salvador",
            "England", "Equatorial Guinea", "Eritrea", "Estonia", "Ethiopia", "Falkland Islands",
            ...
            "Guernsey", "Guinea-Bissau", "Guinea", "Guyana", "Haiti", "Heard and McDonald Islands",
            ...
            "Republic of the Congo", "Reunion", "Romania", "Russian Federation", "Rwanda",
            ...
            "US Minor Outlying Islands", "Uzbekistan", "Vanuatu", "Vatican City State", "Venezuela",
            "Vietnam", "Virgin Islands, British", "Virgin Islands, U.S.", "Wales",
